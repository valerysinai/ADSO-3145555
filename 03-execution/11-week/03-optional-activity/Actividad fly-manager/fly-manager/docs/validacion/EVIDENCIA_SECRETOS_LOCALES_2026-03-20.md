...
- Fecha de ejecucion: 2026-04-28 17:52:57 -05:00
- Env local: C:\fly-manager\infra\docker\.env
- Template: C:\fly-manager\infra\docker\.env.example
...
| gitignore_protects_local_env | True | true o modo academico versionado | OK | Se acepta .env no versionado o .env academico versionado para bootstrap reproducible |
